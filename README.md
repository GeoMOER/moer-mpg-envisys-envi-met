![Course Header](https://github.com/GeoMOER/
moer-msc-envisys-envi-met/blob/master/docs/assets/images/envi_met_title.png "Image source:https://envi-met.info/lib/exe/fetch.php?cache=&media=examples:thermal_pic.png")
